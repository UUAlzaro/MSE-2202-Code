...
unsigned char driveSystem;            // indec for drive mode
    ...
    switch (robotModeIndex) {
      ...
      case 1:                      // case for driving
        ...
        switch (driveSystem) {
          ...
          case 3:  // turn clockwise 90 degrees

            Bot.Right("D1", leftDriveSpeed, rightDriveSpeed);  // drive ID, left speed, right speed
            if (LeftEncoder.lRawEncoderCount >= 200) {
              RightEncoder.clearEncoder();
              LeftEncoder.clearEncoder();
              driveSystem = 4;
            }
          ...
          case 5:  // Turn counter clockwise 90 degrees

            Bot.Left("D1", leftDriveSpeed, rightDriveSpeed);  // drive ID, left speed, right speed
            if (LeftEncoder.lRawEncoderCount <= temp-300) {
              //temp = LeftEncoder.lRawEncoderCount;
              RightEncoder.clearEncoder();
              LeftEncoder.clearEncoder();
              driveSystem = 6;
          ...
          case 7:  // Turn counter clockwise 90 degrees

            Bot.Left("D1", leftDriveSpeed, rightDriveSpeed);  // drive ID, left speed, right speed
            if (LeftEncoder.lRawEncoderCount <= temp-100) {
              //temp = LeftEncoder.lRawEncoderCount;
              RightEncoder.clearEncoder();
              LeftEncoder.clearEncoder();
              driveSystem = 0;
